...
Route::resource('home', 'HomeController', array('only' => array('index')));
...
Route::group(array('prefix' => 'exam'), function() {
    ...
    Route::post('takexam/almacena-res/{idexamen}', 'ExamController@calificacion2'); //Accion que retorna vista de calificacion
    //Preguntas
